/* held-item-strategy.mjs — the PURE HELD-ITEM STRATEGY engine ("compare strategies", chunk P4a).
   ...
   reserved for THIS level; the screen's band/churn/scalp/value are FLIP-NICHES (flip-niches.mjs). The
   API keeps the `path`/`PATH_KEYS` mechanism vocabulary — a path IS a held-item strategy.
