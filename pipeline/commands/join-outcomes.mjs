...
function report(o) {
  ...
  // --- Reachability head-to-head (RC — PLAN-REACHABILITY-CONSOLIDATION) ------------------------
  // The accrual gate here is DELETED, not moved: it clocked closed sell round-trips for a scorer that
