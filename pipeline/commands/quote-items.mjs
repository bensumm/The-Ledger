...
import { hourlyDrift } from '../lib/hourly-lmh.mjs';   // HT2 — the per-hour day-over-day slope read, folded onto every price-recommendation surface (bare quote + held/watched positions), reusing the already-fetched 1h series
