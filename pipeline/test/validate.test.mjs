 ...
 * no live data (rule 4). Run: `node pipeline/test/validate.test.mjs` (exits non-zero on any failure).
 *
 ...
 * degrade) lives in pipeline/test/termstructure.test.mjs (next to the js/termstructure.mjs math it drives).
