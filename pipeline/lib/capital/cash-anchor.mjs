/* cash-anchor.mjs — persist Ben's cash ANCHOR ({ cashGp, statedAt }) for the total-capital read.
   ...
   screen-flip-niches.mjs's --capital default (**deployablePool**, `screen-flip-niches.mjs:234`; this header
   said liquidCapital until 2026-08-09 — liquidCapital is the AMPLITUDE lane's bankroll, `:274`, and every
   other doc had it right) — consumers no longer read this anchor directly.
