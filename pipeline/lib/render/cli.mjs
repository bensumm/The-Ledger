...
/* `--k=v` AND `--k v` both bind k. Only the space form used to, so `--est-sell=<name>` bound the key
 * `est-sell=<name>` and the screen silently ran its default. An unknown KEY is still discarded here. */
