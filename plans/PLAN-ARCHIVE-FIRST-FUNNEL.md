...
**Status: SEVEN CHUNKS STILL OPEN — AF1b · AF3 · AF3b · AF6 · AF7 · AF8 · AF9. Do NOT read this as a
finished plan.** AF6 is the spine of the whole archive-first half and is hard-gated on the archive
exceeding 365×6h ≈ 91.25d (projected ~2026-08-28) plus the 00:00–02:00 local re-run; AF3/AF3b/AF7 hang
off it, and AF8/AF9 off AF7. SHIPPED so far: AF1+AF2 `cdce288` · AF4 `85c7a11` · AF5 `bf6cfa9` · AF5b
`cb102f0` (opt-in `--archive-regime`, deliberately UNPROMOTED). Two SEPARABLE changes in one doc: (A) the
