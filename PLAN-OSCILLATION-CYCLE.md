...
| 4 | READY (unblocked) | — | genuinely-new engineering; watch-positions.mjs + new cycle-watch.json — disjoint from Chunk 6 |
| 5 | READY (unblocked) | — | APP_VERSION bump; shared note path + js/trends.js — run SOLO last (may touch screen-flip-niches shared w/ Chunk 6) |
| 6 | READY (unblocked) | — | parallel-safe across theses; flip-niches.mjs + screen renders — disjoint from Chunk 4 |
